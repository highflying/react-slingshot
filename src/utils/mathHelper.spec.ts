...
describe('Math Helper', () => {
  describe('roundNumber', () => {
    it('returns 0 when passed null', () => {
      expect(MathHelper.roundNumber(null)).toEqual(0);
    });
    ...
    it('rounds up to 1.56 when passed 1.55555 rounded to 2 digits by default', () => {
      expect(MathHelper.roundNumber(1.55555)).toEqual(1.56);
    });
